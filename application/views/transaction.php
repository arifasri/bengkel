                ...
                <div class="col-md-5 col-sm-12">
                    ...
                    <div class="card" id="customerContainer"  style="display:none;background:#000">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                <label>Nama QQ</label>
                                <input type="text" name="nama_qq" class="form-control form-control-sm">
                            </div>
                            <div class="form-group">
                                <label>Nama Sales</label>
                                <input type="text" name="sales" class="form-control form-control-sm">
                            </div>
                            <div class="form-group">
                                <label>Alamat</label>
                            ...
                            <div class="form-group">
                                <label>Nopol/Noka</label>
                                <input type="text" name="plat" class="form-control form-control-sm">
                            </div>
                            <!--
                            <div class="form-group">
                                <label>Diskon</label>
                                <input type="text" name="diskon" class="form-control form-control-sm" id="inputDiskon">
                            </div>
                           !-->
                        </div>
                    </div>
        ...
        <script>
            ...
            function refreshServiceCart(data1,data2) {
               ...
               // var discount = parseInt(jQuery("#inputDiskon").val()) || 0;
            ...
            $(".btn-save-confirm").on("click",function(){
                ...
                if(type == "service") {
                    ...
                    form["sales"] = jQuery("input[name=sales]").val();
