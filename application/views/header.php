        ...
        <nav class="navbar navbar-expand-sm navbar-default">
            ...
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                  ...
                  <h3 class="menu-title">Data Master & Laporan</h3>
                    <li>
                        <a href="<?=base_url("marketing");?>"> <i class="menu-icon fa fa-users"></i>Master Sales </a>
                    </li>
                    <li>
                        <a href="<?=base_url("Ppn");?>"> <i class="menu-icon fa fa-btc"></i>Master PPN </a>
                    </li>
                    <li>
                        <a href="<?=base_url("Paket");?>"> <i class="menu-icon fa fa-dropbox"></i>Master Paket </a>
                    </li>
                    <li>
                        <a href="<?=base_url("customers");?>"> <i class="menu-icon fa fa-users"></i>Master Customer </a>
                    </li>
                    <li>
                        <a href="<?=base_url("supplier");?>"> <i class="menu-icon fa fa-users"></i>Master Supplier </a>
                    </li>
                    <li>
                        <a href="<?=base_url("sparepart");?>"> <i class="menu-icon fa fa-archive"></i>Master Sparepart </a>
                    </li>
                    <li>
                        <a href="<?=base_url("services");?>"> <i class="menu-icon fa fa-cogs"></i>Master Services </a>
                    </li>
                    <li>
                        <a href="<?=base_url("purchase");?>"> <i class="menu-icon fa fa-shopping-cart"></i>Data Pembelian Stock </a>
                    </li>
                    <h3 class="menu-title">Akuntansi</h3>
                    <li>
                        <a href="<?=base_url("coa");?>"> <i class="menu-icon fa fa-book"></i>Master COA </a>
                    </li>
                    <li>   
                        <a href="<?=base_url("bkk");?>"> <i class="menu-icon fa fa-book"></i>Bukti Kas Keluar</a>
                    </li>
                    <li>
                        <a href="<?=base_url("bkm");?>"> <i class="menu-icon fa fa-book"></i>Bukti Kas Masuk</a>
                    </li>
