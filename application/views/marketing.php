        ...
        <div class="content mt-3">
            <div class="card">
                <div class="card-header">
                    <button type="button" class="btn btn-sm btn-success btn-add"><i class="fa fa-plus"></i> Tambah Sales</button>
                </div>
                <div class="card-body">
            ...
            <div class="modal-dialog modal-md" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="largeModalLabel">Tambah Sales</h5>
        ...
        <script>
            $("#data").DataTable({
                ...
                "autoWidth":true,
                "order": [],
                "ajax": {"url": "<?=base_url("Marketing/json");?>"}
            });

            $(".btn-add").on("click",function() {
                jQuery("#compose .modal-title").html("Tambah Sales");
                jQuery("#compose form").attr("action","<?=base_url("Marketing/insert");?>");
            ...
            $("body").on("click",".btn-edit",function(){
                ...
                jQuery.getJSON("<?=base_url("Marketing/get");?>/"+id,function(data){
                    jQuery("#compose form").attr("action","<?=base_url("Marketing/edit");?>/"+id);
            ...
            function deleteData(id) {
                jQuery.getJSON("<?=base_url("Marketing/delete");?>/"+id,function(data){
                    if(data.status) {
                        jQuery("#data").DataTable().ajax.reload(null,true);
