        ...
        <div class="col-1">
            <table>
                <tr>
                    ...
                    <td class="no-td" style="text-decoration-style: dotted;"><?=$fetch->customer;?></td>
                </tr>
                <tr>
                    <td class="no-td">Nama Sales</td>
                    <td class="no-td label">:</td>
                    <td class="no-td"><?=$fetch->sales;?></td>
                </tr>
                <tr>
                    <td class="no-td">Alamat</td>
                    <td class="no-td label">:</td>
                    <td class="no-td"><?=$fetch->alamat;?></td>
                </tr>
                <tr>
                    <td class="no-td">Telepon</td>
                    <td class="no-td label">:</td>
                    <td class="no-td"><?=$fetch->notelp;?></td>
                </tr>
                <tr>
                    <td class="no-td">No Polisi/Chasis</td>
                    <td class="no-td label">:</td>
