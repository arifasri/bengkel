                    ...
                    <div class="modal-body">
                        <form action="" id="compose-form">
                            ...
                            <div class="form-group">
                                ...
                                <select name="akunbkk" class="form-control coa">
        ...
        <script>
                $(".btn-show-add").on("click",function(){
                    ...
                    jQuery("select[name=akunbkk]").val("");
                ...
                $('.btn-submit').on("click",function(){
                    var form = {
                        ...
                        "akunbkk": jQuery("select[name=akunbkk]").val(),
                ...
                $("body").on("click",".btn-edit",function(){
                    var id = jQuery(this).attr("data-id");
                    var customer = jQuery(this).attr("data-uraian");
                    ...
                    jQuery("select[name=akunbkk]").val(akunbkk);
